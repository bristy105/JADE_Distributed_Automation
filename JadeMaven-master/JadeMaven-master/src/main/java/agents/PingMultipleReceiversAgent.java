...
public class PingMultipleReceiversAgent extends Agent {
 ...
 */
    ...
    private class WaitPingAndReplyBehaviour extends CyclicBehaviour { //running all time
    ...
    protected void setup() {
        ...
        sd.setType("PingMultipleReceiversAgent");
        sd.setName(getName());
